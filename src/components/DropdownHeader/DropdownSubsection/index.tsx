...
const DropdownSubsection = ({ links, title }: { links: { name: string; path: string }[]; title: string }) => {
    ...
    return (
        <div className={styles.dropdownSubsectionContainer}>
            <h3 className={[styles.subsectionHeading, isActive ? styles.isActive : ''].join(' ')}>{title}</h3>
